...
if __name__ == '__main__':
    ...
    #trackers.extend(trackerlist('ostrack', 'deitt_256_32x4_got10k_ep100', dataset_name, None, 'OSTrack'))
    #trackers.extend(trackerlist('ostrack', 'selat_256_32x4_got10k_ep100_6_11', dataset_name, None, 'OSTrack'))
    ...
    viser.vis_dataset(dataset, trackers, seq_list=['GOT-10k_Val_000001'])
